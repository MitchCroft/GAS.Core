namespace MC.GAS.Handlers {
     ...
     */
    export class SpreadsheetHandler implements MC.GAS.DI.IInitialisable {
        /*----------Variables---------*/
        //PRIVATE
        ...
        /**
         * Setup the initial values for the elements in the object
         */
        public constructor() {
         ...
         */
        public getSheetWithName(name: string): GoogleAppsScript.Spreadsheet.Sheet {
        ...
        public getSheetsWithMetaData(key: string, value: string): GoogleAppsScript.Spreadsheet.Sheet[] {
            ...
            for (let i = 0; i < foundSheets.length; ++i) {
                ...
                if (!sheet || MC.GAS.StringExtensions.isNullOrEmpty(sheet.getName())) {
                    continue;
                }
         ...
         */
        public createSheet(name: string, metaData: MC.GAS.Mapping<string> = {}): GoogleAppsScript.Spreadsheet.Sheet {
         ...
         */
        public duplicateSheet(template: GoogleAppsScript.Spreadsheet.Sheet, name: string, metaData: MC.GAS.Mapping<string> = {}): GoogleAppsScript.Spreadsheet.Sheet {
