namespace MC.GAS.Config {
     ...
     */
    export class SpreadhseetConfigurationProvider implements IConfigurationProvider, MC.GAS.DI.IInitialisable, MC.GAS.DI.IInjectionTarget {
        /*----------Variables----------*/
        //PRIVATE
         ...
         */
        private _sheetUtility: MC.GAS.Handlers.SpreadsheetHandler;
         ...
         */
        private _valueRange: GoogleAppsScript.Spreadsheet.Range;
         ...
         */
        private _lookup: MC.GAS.Dictionary<number>;
        ...
        public construct(resolver: MC.GAS.DI.IDependencyResolver): void {
            this._sheetUtility = resolver.resolve("SpreadsheetHandler") as MC.GAS.Handlers.SpreadsheetHandler;
        }
        ...
        public init(): void {
            ...
            this._lookup = new MC.GAS.Dictionary<number>();
        ...
        public hasConfigValue(key: string): boolean {
            return this._lookup.hasKey(key);
        }
         ...
         */
        public getConfigValues(collection: ConfigurationCollection): MC.GAS.JObject {
            let result: MC.GAS.JObject = {};
