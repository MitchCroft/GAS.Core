/**
 * Type alias for a generic mapping object that allows for associating a string value with another
 */
export type Mapping<T> = { [key: string]: T; };

/**
 * Type alias for a generic JSON handler object that can be used as such
 */
export type JObject = Mapping<any>;
