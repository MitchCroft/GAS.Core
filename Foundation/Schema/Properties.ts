...
import { ISchemaProperty, IValueValidation } from "./Interfaces";
...
export class SchemaProperty implements ISchemaProperty {
     ...
     */
    private _rules: IValueValidation[] | null;
     ...
     */
    public constructor(name: string, rules: IValueValidation[] | null = null, isOptional: boolean = false, defaultValue: any = undefined) {
        this._name = name;
        this._rules = rules;
        this._complexity = 1;
